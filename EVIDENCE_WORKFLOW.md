...
abstract enrichment are the main calendar win. Pipeline version 1.5.0.
...
- Cochrane and other systematic reviews (Europe PMC + OpenAlex)
...
- Crossref-confirmed DOI seeds for HFrEF briefs: PARADIGM-HF, PIONEER-HF, DAPA-HF,
  ...
  PARAGON-HF, ESC 2021 + 2023 update, 2022 AHA/ACC/HFSA, the Trivandrum (India)
  registry, CSI/India HF management protocols, and Crossref-confirmed qualitative
  papers on living with heart failure (breathlessness, self-care, caregiver labour)
- Official URL seeds when the brief matches (HTTP 200 required): NICE NG106,
  WHO HEARTS (publications page and IRIS handle), WHO CVD fact sheet, WHO NCD
  fact sheet, WHO Global NCD Action Plan, ESC HF guideline page, PAHO HEARTS in
  the Americas, World Bank NCD brief, World Heart Federation heart-failure page
