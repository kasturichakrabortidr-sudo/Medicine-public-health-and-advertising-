...
- Open-access and indexed/paywalled journals (Europe PMC, OpenAlex, Crossref)
- International and national guidelines (ESC, ACC/AHA, NICE, and title-matched guidance)
- UN-system sources: WHO publications and IRIS; OpenAlex institution filters for
  WHO (and regional offices), UNICEF, UNAIDS, UNDP, UNFPA, UNESCO, ILO, UNEP,
  UNHCR, FAO, WFP, IOM, UNODC, and the World Bank
- NGO references (World Heart Federation)
- ClinicalTrials.gov
