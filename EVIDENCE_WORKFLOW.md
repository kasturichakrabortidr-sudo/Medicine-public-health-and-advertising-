...
harvest and registry checks are the main calendar win.
...
- Official URL seeds when the brief matches (HTTP 200 required): NICE NG106,
  WHO HEARTS technical package, ESC heart-failure guideline page, WHO CVD fact sheet
- Crossref-confirmed DOI seeds for HFrEF briefs: PARADIGM-HF, PIONEER-HF, DAPA-HF,
  EMPEROR-Reduced, STRONG-HF, ESC 2021 + 2023 update, 2022 AHA/ACC/HFSA, and the
  Trivandrum (India) heart-failure registry papers
