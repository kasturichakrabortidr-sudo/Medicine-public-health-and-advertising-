...
abstract enrichment are the main calendar win. Pipeline version 1.6.0.

## What it searches

- Open-access and indexed/paywalled journals (Europe PMC, OpenAlex, Crossref, PubMed, Semantic Scholar)
...
- Crossref-confirmed DOI seeds for HFrEF briefs: PARADIGM-HF, PIONEER-HF, DAPA-HF,
  ...
  PARAGON-HF, SHIFT, EMPHASIS-HF, FINEARTS-HF, AFFIRM-AHF, ESC 2021 + 2023 update,
  2022 AHA/ACC/HFSA, the Trivandrum (India) registry, CSI/India HF management
  protocols, and Crossref-confirmed qualitative papers on living with heart
  failure (breathlessness, self-care, caregiver labour)
- Official URL seeds when the brief matches (HTTP 200 required): NICE NG106,
  ...
  India — MoHFW and National Health Mission portals
