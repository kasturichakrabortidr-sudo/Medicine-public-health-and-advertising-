...
abstract enrichment are the main calendar win. Pipeline version 1.7.0.
...
- Official HTTP-200 UN-branch pages this run: UNAIDS, FAO nutrition, ILO OSH,
  UNESCO health education, WFP malnutrition, UN-Habitat, UNDRR, UNODC, plus the
  UN SDG 3 landing page
...
- Crossref-confirmed DOI seeds for HFrEF briefs: PARADIGM-HF, PIONEER-HF, DAPA-HF,
  ...
  EMPULSE, IRONMAN, HEART-FID, SUMMIT, ESC 2021 + 2023 update, 2022 AHA/ACC/HFSA,
...
Each run also writes `references.bib`, `references.ris`, and
