...
BEATS = (
    ...
    {"id": "cohort", "phase": "04", "question": "What does each named insight actually do to the campaign?", "visual": "table", "rail": "Cohort"},
    {"id": "barriers", "phase": "05", "question": "What blocks the pen?", "visual": "table", "rail": "Barriers"},
    ...
    {"id": "gaps", "phase": "03", "question": "What can we not yet say?", "visual": "table", "rail": "Gaps"},
    {"id": "stand", "phase": "06", "question": "Where may we stand, and where are we silent?", "visual": "board", "rail": "Stand"},
    {"id": "message", "phase": "07", "question": "What is the one line we stand behind?", "visual": "stat", "rail": "Message"},
    ...
    {"id": "who", "phase": "09", "question": "Who do we activate first?", "visual": "bar", "rail": "Who"},
    ...
    {"id": "direction", "phase": "11", "question": "What is the coherent bet from here?", "visual": "flow", "rail": "Path"},
