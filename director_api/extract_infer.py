...
LABEL_ALIASES = {
    ...
    "references": "existing_evidence",
    "reference": "existing_evidence",
    "bibliography": "existing_evidence",
    "citations": "existing_evidence",
    "citation": "existing_evidence",
    "pmids": "existing_evidence",
...
def fill_from_prose(brief: ExtractedBrief) -> ExtractedBrief:
    ...
    for field, needles in (
        ...
        ("existing_evidence", ("reference", "bibliography", "citation", "pmid")),
