...
class ResearchPipeline:
        ...
        return {
            "meta": {
                ...
                "time_savings": {
                    ...
                    "how": (
                        "Parallel connector harvest and registry checks, automated "
                        "de-duplication, claim coding, frequency tables, IPA theme "
                        "clustering restricted to qualitative papers, and a "
                        "citation-numbered visual deck replace sequential hand "
                        "searching, reference checking, and slide production."
                    ),
                },
            },
            "brief": self.brief,
    ...
    def _harvest(self) -> list[EvidenceRecord]:
        ...
        if "heart failure" in blob or "hfref" in blob:
            found += connectors.hf_official_seeds()
