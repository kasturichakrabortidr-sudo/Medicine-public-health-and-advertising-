...
EFFECT_RE = re.compile(
    r"\b(?P<metric>HR|OR|RR|(?i:hazard ratio|odds ratio|relative risk|rate ratio))"
    r".{0,70}?"
    r"(?P<value>\d+\.\d+)\s*"
    r"[;,]?\s*(?:\(|\[\s*)?(?:(?i:95\s*%\s*(?:CI|confidence interval(?:\s*\[CI\])?))[:;, ]*)\s*"
...
DOI_SHORT_LABELS = {
    ...
    "10.1002/ejhf.3215": "RELIEVE-HF",
}

_ACRONYM_RE = re.compile(
    r"\b(PARADIGM-HF|PIONEER-HF|DAPA-HF|EMPEROR-Reduced|EMPEROR-Preserved|"
    r"STRONG-HF|VICTORIA|GALACTIC-HF|PARAGON-HF|DELIVER|SHIFT|EMPHASIS-HF|"
    r"FINEARTS-HF|AFFIRM-AHF|SOLOIST-WHF|STEP-HFpEF|EMPULSE|IRONMAN|HEART-FID|SUMMIT|"
    r"RALES|CHARM-Overall|CHARM-Added|TOPCAT|PARADISE-MI|COAPT|ADVOR|CHAMPION|"
    r"MITRA-FR|GUIDE-HF|TRANSFORM-HF|RELIEVE-HF)\b",
    re.I,
)
