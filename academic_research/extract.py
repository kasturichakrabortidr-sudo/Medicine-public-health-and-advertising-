...
IPA_CODEBOOK = {
    "corporeal_disruption": {
        ...
        "needles": [
            r"\b(breathless|fatigue|symptom|body|physical|pain|sleep|oedema|edema)\b"
        ],
        "description": (
    ...
    "biographical_disruption": {
        ...
        "needles": [
            r"\b(identity|normal life|role|self|biograph\w+|independence|loss)\b"
        ],
        "description": (
    ...
    "relational_care": {
        ...
        "needles": [
            r"\b(family|caregiver|carer|trust|communication|doctor|nurse|support)\b"
        ],
        "description": (
    ...
    "existential_uncertainty": {
        ...
        "needles": [
            r"\b(fear|anxi\w+|uncertain|worry|prognosis|death|dying|fragile)\b"
        ],
        "description": (
    ...
    "constrained_agency": {
        ...
        "needles": [
            r"\b(cost|afford|access|adherence|self[- ]manag\w+|barrier|cannot)\b"
        ],
        "description": (
