...
from academic_research.export import (
    to_bibtex,
    to_claim_csv,
    to_forest_csv,
    to_loo_csv,
...
class ExportTests(unittest.TestCase):
    ...
    def test_forest_csv_includes_parsed_ci_and_pooled_row(self):
        ...
        self.assertIn("pooled-random", csv_text)
        loo = to_loo_csv(self.payload)
        self.assertIn("PARADIGM-HF (2014)", loo)
        self.assertIn("0.74", loo)
