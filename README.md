...
then runs claim-frequency analysis, GRADE-style design bands, an inverse-variance
fixed-effect and DerSimonian-Laird random-effects summary of parsed CIs,
leave-one-out sensitivity, and IPA on qualitative papers, and writes a numbered
visual deck plus BibTeX/RIS/CSV/PPTX.
