...
const UA =
  "EvidenceWorkflow/1.3 (https://github.com/kasturichakrabortidr-sudo/medicine-public-health-and-advertising-)";
...
export async function runResearch(brief: Brief) {
  ...
  if (/heart failure|hfref/i.test(`${brief.therapy_area} ${brief.indication}`)) {
    ...
    await add("pioneer", () => europePmc("DOI:10.1056/NEJMoa1812851", 2));
    await add("dapa", () => europePmc("DOI:10.1056/NEJMoa1911303", 2));
    await add("emperor_reduced", () => europePmc("DOI:10.1056/NEJMoa2022190", 2));
    await add("strong_hf", () => europePmc("DOI:10.1016/S0140-6736(22)02076-1", 2));
    await add("esc_doi", () => europePmc("DOI:10.1093/eurheartj/ehab368", 2));
    await add("esc_2023", () => europePmc("DOI:10.1093/eurheartj/ehad195", 2));
    await add("aha_jacc", () => europePmc("DOI:10.1016/j.jacc.2021.12.012", 2));
    await add("trivandrum", () => europePmc("DOI:10.1002/ejhf.283", 2));
  }
  ...
  return {
    meta: {
      generated_at: nowIso(),
      pipeline_version: "1.3.0-netlify",
      validation_policy:
