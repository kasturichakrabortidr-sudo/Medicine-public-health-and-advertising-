  ...
  return (
    <article className="methods">
      ...
      <ul>
        ...
        <li>NICE official guidance URLs when the brief matches (HTTP 200 required), plus WHO HEARTS and regional CVD/NCD pages (SEARO, Europe, Africa), WHO hypertension guideline, SDG 3, PAHO HEARTS, ESC guideline pages, World Bank NCD brief, World Heart Federation, UN-branch health pages (UNAIDS, FAO, ILO, UNESCO, WFP, UN-Habitat, UNDRR, UNODC), and India NHM / MoHFW / ICMR / NPCDCS portals.</li>
      </ul>
      <h2>Inclusion</h2>
      <p>
      ...
      <p>
        ...
        Markdown reference list, BibTeX, RIS, and
        ...
        BibTeX and RIS from the live JSON.
      </p>
      <h2>Re-running</h2>
      <pre>
