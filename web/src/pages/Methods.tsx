  ...
  return (
    <article className="methods">
      ...
      <ul>
        ...
        <li>Cochrane Database of Systematic Reviews via Europe PMC journal filter, plus OpenAlex <code>type:review</code>.</li>
        ...
        <li>NICE official guidance URLs when the brief matches (HTTP 200 required), plus WHO HEARTS and regional CVD/NCD pages (SEARO, Europe, Africa, EMRO, Western Pacific), WHO hypertension guideline, SDG 3, PAHO HEARTS, ESC guideline pages, World Bank NCD brief, World Heart Federation, UN-branch health pages (UNAIDS, FAO, ILO, UNESCO, WFP, UN-Habitat, UNDRR, UNODC, UNFPA, UN Women, UN DESA), ACC guideline hub, KDIGO, and India NHM / MoHFW / ICMR / NPCDCS portals.</li>
      </ul>
      <h2>Inclusion</h2>
      <p>
      ...
      <p>
        ...
        BibTeX, RIS, and CSV from the live JSON.
      </p>
      <h2>Re-running</h2>
      <pre>
