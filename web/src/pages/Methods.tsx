  ...
  return (
    <article className="methods">
      ...
      <ul>
        ...
        <li>NICE official guidance URLs when the brief matches (HTTP 200 required), plus WHO HEARTS, WHO Global NCD Action Plan, PAHO HEARTS in the Americas, ESC guideline pages, and the World Heart Federation heart-failure page.</li>
      </ul>
      <h2>Inclusion</h2>
      <p>
