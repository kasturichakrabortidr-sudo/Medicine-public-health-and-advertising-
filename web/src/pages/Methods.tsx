  ...
  return (
    <article className="methods">
      ...
      <ul>
        ...
        <li>Semantic Scholar Graph API — additional OA and paywalled bibliographic hits.</li>
        ...
        <li>NICE official guidance URLs when the brief matches (HTTP 200 required), plus WHO HEARTS and regional CVD/NCD pages (SEARO, Europe, Africa), WHO hypertension guideline, SDG 3, PAHO HEARTS, ESC guideline pages, World Bank NCD brief, World Heart Federation, and India NHM / MoHFW portals.</li>
      </ul>
      <h2>Inclusion</h2>
      <p>
