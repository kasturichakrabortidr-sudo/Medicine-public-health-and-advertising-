  ...
  return (
    <article className="methods">
      ...
      <ul>
        ...
        <li>OpenAlex institutions: WHO and regional offices (including EMRO and WPRO), PAHO, UNICEF, UNAIDS, UNDP, UNFPA, UNESCO, ILO, UNEP, UNHCR, FAO, WFP, IOM, UNODC, UN Women, UN-Habitat, ITU, UN DESA, World Bank, World Heart Federation.</li>
      ...
      <p>
        ...
        trial. A fixed-effect inverse-variance summary, a DerSimonian-Laird
        random-effects summary, leave-one-out rows, and a funnel (precision vs
      ...
      <p>
        ...
        table lists each parsed CI plus the inverse-variance pooled row and the
        DerSimonian-Laird random-effects row. <code>leave-one-out.csv</code>
        lists the fixed-effect HR after dropping each named trial.
      </p>
      <h2>Re-running</h2>
      <pre>
