  ...
  return (
    <>
      ...
      <section className="workflow" aria-label="Seven-step workflow">
        {[
          ["01 Search", "Europe PMC (OA + mixed), OpenAlex (including OA-only and guideline titles), Crossref, PubMed/MeSH, Semantic Scholar, DOAJ, Unpaywall, Cochrane, preprints, WHO IRIS, UN institutions (including EMRO/WPRO, UNICEF, ITU, OHCHR), ClinicalTrials.gov (including completed-with-results), ACC, KDIGO, CSI, CDSCO"],
          ...
          ["05 Quant", "Frequency of supporting facts; forest plot; fixed-effect + DerSimonian-Laird pooled HR; leave-one-out; funnel; GRADE-style design bands; geography"],
          ["06 Qual", "Narrative review + IPA superordinate themes"],
          ["07 Deck", "Visual slides plus BibTeX, RIS, and a numbered PPTX"],
        ].map(([t, d]) => (
      ...
      <section className="grid-3">
        <article className="card">
          ...
          <p>
            ...
            analyst hours. This workflow targets ~10 hours of oversight (75%
