  ...
  return (
    <>
      ...
      <section className="workflow" aria-label="Seven-step workflow">
        {[
          ["01 Search", "Europe PMC, OpenAlex, Crossref, PubMed, Semantic Scholar, Unpaywall, Cochrane, WHO IRIS, UN institutions, ClinicalTrials.gov"],
          ...
          ["05 Quant", "Frequency of supporting facts; forest plot; GRADE-style design bands"],
