  ...
  return (
    <>
      ...
      <section className="workflow" aria-label="Seven-step workflow">
        {[
          ["01 Search", "Europe PMC, OpenAlex (including OA-only), Crossref, PubMed, Semantic Scholar, DOAJ, Unpaywall, Cochrane, preprints, WHO IRIS, UN institutions (including EMRO/WPRO), ClinicalTrials.gov, ACC, KDIGO"],
          ...
          ["05 Quant", "Frequency of supporting facts; forest plot; GRADE-style design bands; geography"],
