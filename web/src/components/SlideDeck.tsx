...
function buildSlides(deck: DeckPayload) {
  ...
  return [
      ...
      node: (
        <>
          ...
          <p>
            ...
            Crossref, PubMed/MEDLINE, Unpaywall OA flags), Cochrane/systematic
            reviews, national and international guidelines (ESC, AHA, NICE, ICMR
            when retrieved), WHO IRIS, WHO publications, UN-system institutions
            on OpenAlex (WHO, PAHO, UNICEF, UNAIDS, UNDP, UNFPA, UNESCO, ILO,
            UNEP, UNHCR, FAO, WFP, IOM, UNODC, UN Women, UN-Habitat, ITU, UN
            DESA, World Bank), NGOs, and ClinicalTrials.gov. Paywalled papers
    ...
    },
    {
      ...
      node: (
        <>
          <h2>06 · Anti-hallucination contract</h2>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>07 · Quantitative frequency analysis</h2>
          <p>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>08 · Supporting-fact table with citations</h2>
          <table className="table">
            <thead>
              <tr>
                <th>Claim</th>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>09 · Claim × source infographic</h2>
          <p>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>10 · Publication years, access, and study design</h2>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>11 · Forest plot of parsed effect sizes</h2>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>12 · Evidence-certainty table (design bands)</h2>
          <p>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>13 · Pivotal trials and guidelines carousel</h2>
          <p>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>14 · International and national guidelines</h2>
          <table className="table">
            <thead>
              <tr>
                <th>#</th>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>15 · UN branches and non-profit references</h2>
          <p>
            ...
            Official URL seeds (HTTP 200) this run also include WHO HEARTS, the
            WHO NCD fact sheet, PAHO HEARTS in the Americas, and the World Bank
            NCD brief.
          </p>
          <table className="table">
            <thead>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>18 · Insights for {deck.insights.cohort}</h2>
          <div className="grid-2" style={{ padding: 0 }}>
            <div>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>19 · Novel angles and evidence gaps</h2>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>20 · Ready to drop into a campaign evidence section</h2>
          <ol>
    ...
    },
    {
      ...
      node: (
        <>
          <h2 id="ref-1">21 · Numbered, registry-validated references</h2>
