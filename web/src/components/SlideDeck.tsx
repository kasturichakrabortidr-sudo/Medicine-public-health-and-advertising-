      ...
      node: (
        <>
          ...
          <p>
            ...
            Cochrane Database records, national and international guidelines
            ...
            Official URL seeds add WHO regional CVD/NCD pages, SDG 3, and India
            ministry portals when the brief matches. Paywalled papers contribute
            title/abstract/DOI only — full text is never scraped.
          </p>
      ...
      node: (
        <>
          ...
          <p>
            ...
            regional CVD/NCD pages (SEARO, Europe, Africa), SDG 3, the WHO
            hypertension guideline, PAHO HEARTS, the World Bank NCD brief, and
            India NHM / MoHFW portals when the market matches.
          </p>
          {agencyData.length ? (
