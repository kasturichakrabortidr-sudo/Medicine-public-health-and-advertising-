...
function buildSlides(deck: DeckPayload) {
  ...
  return [
    ...
    },
    {
      ...
      node: (
        <>
          <h2>11 · International and national guidelines</h2>
          <table className="table">
            <thead>
              <tr>
                <th>#</th>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>12 · UN branches and non-profit references</h2>
          <p>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>15 · Insights for {deck.insights.cohort}</h2>
          <div className="grid-2" style={{ padding: 0 }}>
            <div>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>16 · Novel angles and evidence gaps</h2>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>17 · Ready to drop into a campaign evidence section</h2>
          <ol>
    ...
    },
    {
      ...
      node: (
        <>
          <h2 id="ref-1">18 · Numbered, registry-validated references</h2>
