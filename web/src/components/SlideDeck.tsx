      ...
      node: (
        <>
          ...
          <p>
            ...
            Cochrane Database records, DOAJ, preprint indexes, a dedicated
            OpenAlex OA-only harvest, national and
            international guidelines (ESC, AHA, ACC, NICE, KDIGO, ICMR / NPCDCS when
            ...
            Pacific), SDG 3, UN-branch health pages, and India
      ...
      node: (
        <>
          ...
          <p>
            ...
            UNODC, UNFPA, UN Women, UN DESA), WHO regional CVD/NCD pages
            (SEARO, Europe, Africa, EMRO, Western Pacific), the WHO hypertension
            guideline, PAHO HEARTS, the World Bank
            NCD brief, ACC, KDIGO, and India NHM / MoHFW / ICMR / NPCDCS portals when the
            market matches.
          </p>
          {agencyData.length ? (
