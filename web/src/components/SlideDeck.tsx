...
function buildSlides(deck: DeckPayload) {
  ...
  return [
    ...
    },
    {
      ...
      node: (
        <>
          <h2>14 · Evidence-certainty table (design bands)</h2>
          <p>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>15 · Pivotal trials and guidelines carousel</h2>
          <p>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>16 · International and national guidelines</h2>
          <table className="table">
            <thead>
              <tr>
                <th>#</th>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>17 · UN branches and non-profit references</h2>
          <p>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>18 · Where the included evidence sits</h2>
          <p>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>21 · Insights for {deck.insights.cohort}</h2>
          <div className="grid-2" style={{ padding: 0 }}>
            <div>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>22 · Novel angles and evidence gaps</h2>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>23 · Ready to drop into a campaign evidence section</h2>
          <ol>
    ...
    },
    {
      ...
      node: (
        <>
          <h2 id="ref-1">24 · Numbered, registry-validated references</h2>
