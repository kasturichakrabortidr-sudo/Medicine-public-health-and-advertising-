...
function buildSlides(deck: DeckPayload) {
  ...
  return [
      ...
      node: (
        <>
          ...
          <p>
            ...
            Crossref metadata), national and international guidelines, WHO IRIS,
            WHO publications, UN-system institutions on OpenAlex, NGOs, and
            ClinicalTrials.gov. Paywalled papers contribute title/abstract/DOI
            only — full text is never scraped.
          </p>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>08 · Publication years and access</h2>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>09 · Forest plot of parsed effect sizes</h2>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>10 · International and national guidelines</h2>
          <table className="table">
            <thead>
              <tr>
                <th>#</th>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>11 · UN branches and non-profit references</h2>
          <p>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>14 · Insights for {deck.insights.cohort}</h2>
          <div className="grid-2" style={{ padding: 0 }}>
            <div>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>15 · Novel angles and evidence gaps</h2>
    ...
    },
    {
      ...
      node: (
        <>
          <h2>16 · Ready to drop into a campaign evidence section</h2>
          <ol>
    ...
    },
    {
      ...
      node: (
        <>
          <h2 id="ref-1">17 · Numbered, registry-validated references</h2>
