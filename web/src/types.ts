...
export interface PooledEffect {
  ...
  q?: number;
  funnel: FunnelPoint[];
  random_effect?: RandomEffect | null;
...
export interface DeckPayload {
  ...
  quantitative: {
    ...
    geography?: { id: string; count: number; percent: number; citation_ids: number[] }[];
    connector_yield?: { connector: string; query?: string; hits: number; ok: boolean }[];
